...
public class SimilarityCalculator {
    ...
    public double calculateSimilarity(UserMatchPreference preference, UserProfile profile) {
        ...
        // 흡연 점수
        double smokerScore = calculateBooleanScore(preference.isSmoker(), profile.isSmoker());

        // 수면 점수
        double sleepScore = calculateIntegerScore(preference.getSleepTime(), profile.getSleepTime());

        // 반려동물 점수
        double petScore = calculateBooleanScore(preference.isPetAllowed(), profile.isPetAllowed());
        ...
        double snoringScore = calculateBooleanScore(preference.isSnoring(), profile.isSnoring());
